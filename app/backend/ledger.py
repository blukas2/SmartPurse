...
class Ledger:
    ...
    def _collect_all_data(self):
        ...
        self.granular_data = pd.concat(dataframes)

    def _aggregate_data(self):
        self.aggregated_data = (self.granular_data
                                .groupby([
                                    'Month', 'Account Name', 'main_category', 'subcategory', 'budget_item'
                                ])['Amount'].aggregate('sum')).reset_index()
